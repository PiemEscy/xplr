      ...
      <div className="flex h-16 items-center justify-between px-4 md:px-6">
        ...
        <nav className="hidden md:flex items-center justify-center">
          <ul className="flex items-center gap-1 rounded-full border app-border-theme-color app-bg-theme-color-secondary p-1.5">
            ...
            <li>
              <button className="flex items-center gap-2 rounded-full app-bg-theme-color-secondary border app-border-theme-color px-4 py-1.5 text-sm font-medium app-text-theme-secondary-color shadow-sm ring-1 ring-white/10">
